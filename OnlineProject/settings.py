...
import os
from django.contrig.messages import constants as error_messages
...
SECRET_KEY = 'django-insecure-d&utaisu8()sf(1pzxow^dy5d&mwj!e$l$c354_@u@-)y-i3xa'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'shopping_cart.context_processor.total_shopping_cart'
            ],
        },
    },
]
